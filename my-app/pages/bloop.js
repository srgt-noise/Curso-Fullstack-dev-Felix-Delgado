...
function MoodRecommender() {
    ...
    return (
        <section style={{ display: 'flex', justifyContent: 'center', marginTop: '3em', color: 'black' }}>
    <div className="flex flex-col rounded-lg shadow-lg bg-white p-8 max-w-md mx-auto" style={{ color: 'black' }}>
        <h1 className="text-2xl font-bold mb-4" style={{ color: 'black' }}>How are you feeling today?</h1>
        {questionState.videoUrl ? (
            <div>
                <h2 className="text-lg font-semibold mt-6" style={{ color: 'black' }}>Recommended Video:</h2>
            ...
            <div>
                {questionState.currentQuestion === 1 && (
                    <div>
                        <p className="mb-2" style={{ color: 'black' }}>Question 1: How was your day?</p>
                ...
                {questionState.currentQuestion === 2 && (
                    <div>
                        <p className="mb-2" style={{ color: 'black' }}>Question 2: How much energy do you have?</p>
                ...
                {questionState.currentQuestion === 3 && (
                    <div>
                        <p className="mb-2" style={{ color: 'black' }}>Question 3: What do you need right now?</p>
