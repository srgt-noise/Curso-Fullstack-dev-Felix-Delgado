    ...
    <>
      <div>
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
          ...
          <a href="/index"><img src="https://i.ibb.co/N3z8qq9/Bloop.png" alt="Bloop" border="0" /></a>
          </Link>
      ...
      <section>
      <footer className="bg-white rounded-lg shadow m-4 dark:bg-gray-800 fixed bottom-0 w-full flex justify-center">
